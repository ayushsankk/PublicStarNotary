...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Amaze Star";
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        //require(tokenIdToStarInfo[_tokenId].name != 0, "No star found");
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "User is not the owner of either of the stars");
